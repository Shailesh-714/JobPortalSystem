...
<body>
   ...
   <div class="login">
      ...
      <form method="post" action="empRegistration" class="login__form">
      
         <h1 class="login__title">Register as Employer</h1>
         <div class="login__inputs">
            <div class="login__box">
               <input type="text" name="name" id="name" placeholder="Company Name" required class="login__input">
            ...
            <div class="login__box">
               <input type="text" name="organization_type" id="organization_type" placeholder="Organization Type" required class="login__input">
               <i class="ri-building-fill"></i>
            </div>

            <div class="login__box">
               <input type="text" name="location" id="location" placeholder="Location" required class="login__input">
            ...
            <div class="login__box">
               <input type="text" name="website" id="website" placeholder="Website" required class="login__input">
               <i class="ri-earth-fill"></i>
            </div>

            <div class="login__box">
               <textarea name="company_description" id="company_description" placeholder="Description of the Company" required class="login__input"></textarea>
         ...
         <div class="login__register">
            Already have an account? <a href="emp_login.jsp">Login</a>
         </div>
      </form>
   </div>
